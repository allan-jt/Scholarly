...
import asyncio
from routes.arxiv import query_arxiv
...
async def query_advanced(
    ...
    # arxiv_data, elsevier_data, ieee_data = await asyncio.gather(query_arxiv(), query_elsevier(), query_ieee())

    arxiv_data = await query_arxiv(**query_params)
